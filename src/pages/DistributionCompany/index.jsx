...
const DistributionCompany = () => {
  ...
  const [distributionCompanyTime, setDistributionCompanyTime] = useState(0);
  const [distributionCompanyAmount, setDistributionCompanyAmount] = useState(0);
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(
      ...
      formInput?.distributionCompanyID, formInput?.productName, formInput?.origin, formInput?.batchNo,
    ...
    const receipt = await provider
      ...
      .then(() => {
        toast.success("DistributionCompany details logged Successfully !!");
      });
  };
